  ...
  return (
    <div className="md:bordder-x-0 mt-6 grid grid-cols-1 gap-x-4 border px-4 py-4 md:grid-cols-4 md:border-b-0 md:border-t md:pb-0">
      <div className="space-y-2 py-4">
        ...
        <button
          onClick={openPortal}
          className="h-10 w-3/5 whitespace-nowrap bg-gray-300 py-2 text-sm font-medium text-black shadow-md transition-all hover:bg-gray-200 md:w-4/5"
        >
      ...
      <div className="col-span-3">
        ...
        <div className="flex flex-col justify-between pb-4 pt-4 md:flex-row md:pb-0">
          <div>
            <div className="flex items-center gap-2">
              <span className="rounded bg-white/20 px-3 py-1 uppercase">
