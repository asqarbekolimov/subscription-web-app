...
const Hero = ({ trending }: HeroProps) => {
  ...
  return (
    <div className="flex flex-col space-y-2 py-20 md:space-y-4 lg:h-[65vh] lg:justify-center lg:pb-12">
      ...
      <div>
        <button className="flex h-[56px] w-[200px] items-center justify-center space-x-2 rounded-full bg-white/60 px-8 py-4 font-bold text-black transition-all hover:bg-white/80">
          Watch Now
